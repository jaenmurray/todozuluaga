...
using todozuluaga.Common.Models;
using todozuluaga.Common.Responses;
using todozuluaga.Functions.Entities;

namespace todozuluaga.Funtions.Funtions
{
    public static class TodoApi
    {
        ...
        ILogger log)
        {
            ...
            string message = $"Todo: {todoEntity.RowKey}, deteled.";
            log.LogInformation(message);
